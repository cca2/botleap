...
var botTokens = [process.env.SLACK_BOT_TOKEN, 'xoxb-253188456194-pvZYyuTKlHq4HtVd0t2KdNB1']
...
botTokens.forEach(function(token) {
	...
	rtm.on(RTM_EVENTS.MESSAGE, function handleRtmMessage(message) {
		...
		if ((message.username != 'projetaobot' && message.username != 'leap' && message.username != 'leapacademy') && isBotChannel) {
